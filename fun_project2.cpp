...
#include <string>
#include <map>
#include <emscripten.h/emscripten.h>
using namespace std;

// Decryption function
extern "C" {
    EMSCRIPTEN_KEEPALIVE
    const char* decrypt(const char* code) {
        static string decodedText; // Static to persist data after function returns
        decodedText.clear();
        ...
        return decodedText.c_str(); // Return the decoded text
    }
}
